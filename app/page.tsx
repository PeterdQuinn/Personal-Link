...
export default function Home() {
  ...
  const clients = [
    {
      ...
      niche:
        "Arizona-based family-owned vending machine service offering free candy machine placement for local businesses with charitable partnerships.",
      category: "client",
      icon: "👑",
    },
    {
      ...
      niche:
        "Professional sports facility platform offering 1-on-1 coaching and group training sessions for athletes looking to improve their game.",
      category: "client",
      icon: "⚡",
    },
    {
      ...
      niche:
        "Modern job search platform connecting job seekers with opportunities through streamlined application processes and career resources.",
      category: "client",
      icon: "🎯",
    },
    {
      ...
      niche:
        "24/7 emergency towing and roadside assistance with real-time dispatch and GPS tracking for the greater Phoenix area.",
      category: "client",
      icon: "🛻",
    },
    {
      ...
      niche:
        "Professional music production platform featuring artist portfolios, booking systems, and project management tools.",
      category: "client",
      icon: "🎵",
    },
    {
      ...
      niche:
        "Comprehensive staffing solutions with automated matching systems serving multiple industries with temp and permanent placements.",
      category: "client",
      icon: "💼",
    },
    // AZ PVA intentionally excluded
    {
      name: "Mindful Creations",
      url: "https://www.mindful-creations.org",
      description: "Grief & Mindfulness Support",
      niche:
        "Nonprofit platform offering grief counseling resources, mindfulness programs, and safe community support networks.",
      category: "client",
      icon: "🌸",
    },
    {
      name: "AZ Preferred Flooring",
      url: "https://www.azpreferredflooring.com",
      description: "Flooring Installation Services",
      niche:
        "Professional flooring contractor platform with project galleries and estimate calculators for residential and commercial projects.",
      category: "client",
      icon: "🏗️",
    },
    {
      ...
      niche:
        "Enterprise networking and IT infrastructure services with comprehensive network solutions for businesses of all sizes.",
      category: "client",
      icon: "🌐",
    },
    {
  ...
  const demoApps = [
    {
      ...
      niche:
        "Comprehensive medical practice management with patient portals, appointment scheduling, and telemedicine capabilities.",
      category: "demo",
      icon: "🏥",
    },
    {
      ...
      niche:
        "Multi-tenant business management platform showcasing dashboard analytics and enterprise-level features.",
      category: "demo",
      icon: "📊",
    },
    {
      ...
      niche:
        "Complete SaaS solution for search engine optimization with keyword tracking, competitor analysis, and performance reporting.",
      category: "saas",
      icon: "📈",
    },
    {
    ...
    },
    {
      ...
      niche:
        "Smart gym solution with AI-driven workout planning, tracking, and member portals.",
      category: "demo",
      icon: "🏋️",
    },
    {
      name: "Echelon Concierge (Demo)",
      url: "https://ech-rho.vercel.app/",
      description: "High-End Concierge Demo",
      niche:
        "Luxury booking/concierge flow showcasing AI-assisted intake and scheduling.",
      category: "demo",
      icon: "🛎️",
    },
    {
      name: "Weed AI (Demo)",
      url: "https://weed-ai-alpha.vercel.app/",
      description: "Cannabis AI Assistant",
      niche:
        "Product discovery and FAQs with AI search tuned for cannabis retail.",
      category: "demo",
      icon: "🌿",
    },
  ];
  ...
  const filterOptions = [
    { key: "all", label: "All Projects", count: allProjects.length },
    {
      ...
      count: [...clients, ...demoApps].filter((c) => c.category === "saas")
        .length,
    },
    {
      key: "client",
      label: "Client Sites",
      count: clients.filter((c) => c.category === "client").length,
    },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white relative overflow-hidden">
      ...
      <div
        className="fixed inset-0 bg-[radial-gradient(circle_at_80%_70%,rgba(59,130,246,0.15),transparent_70%)] animate-pulse"
        style={{ animationDelay: "2s" }}
      ></div>
      <div
        className="fixed inset-0 bg-[radial-gradient(circle_at_50%_20%,rgba(236,72,153,0.1),transparent_60%)] animate-pulse"
        style={{ animationDelay: "4s" }}
      ></div>

      {/* Floating Elements */}
      <div
        className="fixed top-20 left-10 w-2 h-2 bg-blue-400 rounded-full animate-bounce opacity-60"
        style={{ animationDelay: "1s" }}
      ></div>
      <div
        className="fixed top-40 right-20 w-1 h-1 bg-purple-400 rounded-full animate-bounce opacity-60"
        style={{ animationDelay: "3s" }}
      ></div>
      <div
        className="fixed bottom-32 left-20 w-1.5 h-1.5 bg-pink-400 rounded-full animate-bounce opacity-60"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        >
          ...
          <p className="text-base sm:text-lg lg:text-xl text-white/80 mb-8 sm:mb-10 leading-relaxed max-w-4xl mx-auto font-medium">
            Discover our portfolio of cutting-edge websites, SaaS platforms, and
            digital solutions that drive growth and connect communities across
            Arizona.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-8 sm:mb-12">
            <a
              href="https://calendly.com/fullstackservicesllc/15min"
              target="_blank"
            ...
            <a
              href="https://fullstackservicesllc.net"
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto"
            >
          ...
          <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-xl rounded-3xl p-8 sm:p-12 lg:p-16 border border-white/10 shadow-2xl text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-white/80 mb-8 sm:mb-12 leading-relaxed max-w-4xl mx-auto font-medium">
                Join our network of successful businesses. From concept to
                launch, we build premium digital solutions that drive growth and
                connect communities.
              </p>
      ...
      <footer className="relative z-10 mt-16 sm:mt-20 lg:mt-24 border-t border-white/10 bg-slate-900/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center">
          <p className="text-sm sm:text-base text-white/60 font-medium">
            &copy; {new Date().getFullYear()} Full Stack Services LLC. Crafting
